...
`;function lt(t){if(!t||"unknown"===t||"Unknown"===t)return"—";const e=String(t).trim();if(!e)return"—";const i=e.match(/(\d{1,2}):(\d{2})(?::\d{2})?/);if(i)return`${i[1].padStart(2,"0")}:${i[2]}`;try{const t=new Date(e);return isNaN(t.getTime())?e:t.toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",hour12:!1})}catch(t){return e}}function dt(t){return t?t.is_cancelled?"cancelled":t.is_no_service?"no-service":t.delay_minutes>=10?"major-delay":t.delay_minutes>0?"minor-delay":"on-time":"unknown"}function ht(t,e=!0){return e&&t?t.is_cancelled?"❌":t.is_no_service?"⊗":t.delay_minutes>=10?"🔴":t.delay_minutes>0?"⚠️":"✓":""}function pt(t){return t?t.is_cancelled?"Cancelled":t.is_no_service?"No service":t.delay_minutes>0?`Delayed ${t.delay_minutes} min${1!==t.delay_minutes?"s":""}`:"On time":"Unknown"}customElements.define("my-rail-commute-card-editor",class extends ot{static get properties(){return{hass:{type:Object},_config:{type:Object}}}static get styles(){return n`
    ...
    `}_renderDisruptionBanner(){if(!this._hasDisruption)return"";const t=(this._disruptionSeverity||"severe").toLowerCase(),e=t.includes("minor")||t.includes("light")||t.includes("low"),i=e?"disruption-minor":"disruption-severe",s=e?"Minor disruption":"Severe disruption",a=e?"mdi:alert":"mdi:alert-circle",n=!!this.config.disruption_entity;return B`
      <div
        class="disruption-banner ${i} ${n?"disruption-clickable":""}"
    ...
    `}_renderTrainRow(t){const e=dt(t),i=!1!==this.config.status_icons?ht(t):"",s=!1!==this.config.show_platform,a=!1!==this.config.show_operator,n=!1!==this.config.show_delay_reason,o=!0===this.config.show_calling_points,r=!0===this.config.show_journey_time;return B`
      <div
        class="train-row ${e}"
